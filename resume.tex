...
\begin{changemargin}{0.5in}{0.5in}
	\begin{center}
		\begin{tabular}{ccc}
			...
			\parbox[t]{6cm}{\center{\vspace{0.25cm} {\small agural@stanford.edu $|$ 703.346.2869}\\
...
\begin{body}
	...
	%\item \textbf{Selected Coursework:} Fundamentals of Analog IC Design, Advanced Analog IC Design, RF IC Design, Analog-Digital Interface Circuits, Digital Signal Processing
	...
	\item \textbf{Awards:} ACM-ICPC (collegiate programming contest) international contestant \textit{Thailand, 2016}%,\\The Kiyo and Eiko Tomiyasu SURF Scholar award (Caltech, \textit{2015}), Tau Beta Pi honor society member
	\end{itemize}
...
\begin{body}
	...
	\vspace*{-4pt}
	\begin{itemize}
		\item \emph{Analog-Digital Interface Circuits:} Developed and conducted office hours, recorded review sessions, homework, and an ADC design project. Topics covered include sampling and signal processing, analysis of noise in mixed-signal circuits, and ADC/DAC design.% Received very positive reviews from students.
...
\begin{body}
	\vspace{14pt}
	C, \CC, Python (numpy, scipy, scikit-learn, PyTorch, TensorFlow), Mathematica, Matlab, \LaTeX, VHDL/Verilog, Java, SPICE, Cadence Virtuoso
