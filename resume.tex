...
\begin{body}
	...
	\item \textbf{Selected Coursework:} Fundamentals of Analog Integrated Circuit Design, Advanced Analog Integrated Circuit Design, Principles and Models of Semiconductor Devices, Digital Signal Processing
	%\item \textbf{Research:}
...
\begin{body}
	\vspace{14pt}
	C/\CC, Python, VHDL/Verilog, Java, OCaml, Haskell, x86 Assembly, \LaTeX, Mathematica, Git, Bash, OpenCV, MPI (parallelization platform), Altium, Altera and Xilinx toolchains, SPICE, Cadence Virtuoso
\end{body}
